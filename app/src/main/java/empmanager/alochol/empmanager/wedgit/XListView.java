 ...
 */
package empmanager.alochol.empmanager.wedgit;
...
public class XListView extends ListView implements OnScrollListener, NestedScrollingChild {
	...
	public void stopRefresh() {
		...
		if (mPullRefreshing == true) {
			Log.d(TAG, "======= stopRefresh mPullRefreshing true =======");
...
//		Log.e(TAG, "--- dispatch nested scroll ---> " + dyConsumed);
...
//		Log.e(TAG, "--- dispatch nested pre scroll ---> " + dy);
		this.dy = dy;
...
//		Log.e(TAG, "--- dispatch nested fling ---> " + velocityY);
		return mScrollingChildHelper.dispatchNestedFling(velocityX, velocityY, consumed);
	}

	@Override
	public boolean dispatchNestedPreFling(float velocityX, float velocityY) {
//		Log.e(TAG, "--- dispatch nested pre fling ---> " + velocityY);
