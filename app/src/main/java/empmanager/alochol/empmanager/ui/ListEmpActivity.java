...
public class ListEmpActivity extends BasePageListActivity<Employee> {
...
//        obtainUserList(mName, mMinAge, mMaxAge, mGender);
    ...
    private void obtainUserList(String name, String minAge, String maxAge, String gender, int page) {
        ...
        OkHttpUtils
                .get()
                .url(Constants.URL_EMPLOYEE_BY_PAGE + "?page=" + page)
                .params(map)
                .build()
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        List<Employee> employees = GsonUtil.jsonToList(GsonUtil.GsonString(pageInfo.getList()), Employee.class);
